...
;; Andrew Whaley, 2009 -
;; Shamelessy cut'n'pasted from the Gambit library directory and chopped out 
;; everything other than sha-1.
;; 
;; Had the original file not included the test cases, it could have been used
;; in situ.
